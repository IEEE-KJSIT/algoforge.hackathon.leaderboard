...
const TEAMS = [
  ...
  { id: '1', teamName: 'lorem ipsum', projectName: 'AI-Driven Personalized Study Companion for Smarter Exam Prep', score: 165, rank: 2 },
  { id: '13', teamName: 'Unfortunately Fortunate', projectName: 'Intellex: Bridging the Information Gap for New Employees & Interns', score: 107, rank: 3 },
  { id: '20', teamName: 'Team PASH', projectName: 'PandaLearn', score: 148, rank: 4 },
  { id: '18', teamName: 'KnowWiz', projectName: 'Vision AI', score: 165, rank: 5 },
  { id: '22', teamName: '</ByteZeta>', projectName: 'Vidhik: E-Governance with AI & Blockchain', score: 135, rank: 6 },
  { id: '2', teamName: 'V4', projectName: 'VendorAI', score: 124, rank: 7 },
  { id: '19', teamName: 'Mappa', projectName: 'MAPPA – Your AI Enhanced Collaboration Hub', score: 120, rank: 8 },
  { id: '3', teamName: 'Tech Shastra', projectName: 'SMART SHOPPING TROLLEY: ONE STOP SOLUTION FOR QUEUE FREE SHOPPING', score: 115, rank: 9 },
  { id: '11', teamName: 'MangoDB', projectName: 'Smart Fasal - MangoDB', score: 114, rank: 10 },
  { id: '4', teamName: 'Anon', projectName: 'Sanjeevani', score: 113, rank: 11 },
  { id: '21', teamName: 'Unpaid Labours', projectName: 'FoodHero: A Gamified, AI-Driven Food Donation Platform', score: 111, rank: 12 },
